...
-@Injectable: Faz a injeção de dependências e informa ao angular.
Exemplo: (Quando o módulo principal for carregado, as informações
do service serão implementadas)
@Injectable({
    providedIn: 'root'
})
